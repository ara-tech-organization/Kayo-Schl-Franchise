      ...
      <div className="wrap form-grid">
        <Reveal className="form-side" dir="left">
          ...
          <h2 className="sec-title">
            Check franchise availability in your city
          </h2>
          <p className="sec-sub">
            Two quick steps. Step one takes 30 seconds. Step two helps us
            prepare a serious, city-specific answer — not a generic sales call.
          </p>
          <div className="promise">
            <Icon
              name="clock"
              size={20}
              style={{ color: "var(--yellow)", flex: "0 0 auto" }}
            />
            <span>
              <b>Response within 1 working day.</b> A city-fit answer and the
              investment brief — no obligation, no spam.
            </span>
          </div>
          <div className="promise">
            <Icon
          ...
          <div className="promise">
            ...
            />
            <span>
              <b>Franchise enquiries only.</b> Parent admission enquiries are
              routed separately — your details go straight to the franchise
              team.
            </span>
          </div>
        </Reveal>
  ...
  return (
    <>
      <div className="disclaimer-strip">
        <div className="wrap">
          All investment figures, scenario models and franchisee results shown
          in [brackets] are placeholders pending verification and approval by
          Kayo International leadership. Scenario outputs are illustrative and
      ...
      <footer>
        <div className="wrap foot-grid">
          ...
          <div>
            ...
            <br />
            Franchise desk: <a href={CONTACT.phoneHref}>
              {CONTACT.phone}
            </a> ·{" "}
            <a
    ...
    >
      <div className="modal">
        ...
        <span className="eyebrow">
          {brochure
            ? "Franchise investment brief"
            : "One operator per territory"}
        </span>
        <h3 id="popup-title">
          {brochure
            ? "Where should we send the brochure?"
            : "Is your city still available?"}
        </h3>
